...
Answer.create!([
  ...
  #  2 вопрос
  { body: 'Экзосфера, термосфера, мезосфера, стратосфера', correct: true, question_id: at_question_2.id },
  { body: 'Термосфера, экзосфера, мезосфера, стратосфера', correct: false, question_id: at_question_2.id },
  { body: 'Мезосфера, термосфера, стратосфера, тропосфера', correct: false, question_id: at_question_2.id },
  { body: 'Стратосфера, мезосфера, экзосфера, термосфера', correct: false, question_id: at_question_2.id },
   #  3 вопрос
